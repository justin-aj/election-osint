...
import { Map as MapIcon, Video, Radar, Radio, TrendingUp } from "lucide-react";

export type CenterMode = "signals" | "videos" | "map" | "live" | "trends";
...
export function CenterModeSwitcher({
  ...
  const modes: CenterMode[] = showLive ? ["live", "signals", "videos", "map", "trends"] : ["signals", "videos", "map", "trends"];
  return (
